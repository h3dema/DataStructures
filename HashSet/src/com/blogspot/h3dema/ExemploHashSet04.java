...
/**
 * demonstra como usar HashSet.remove()
 * @author Henrique
 */
public class ExemploHashSet04 {
    ...
    public static void main(String[] args) {
        ExemploHashSet04 exemplo = new ExemploHashSet04();
        exemplo.criaHash();
        System.out.println(exemplo.hash);
        exemplo.removeElemento(exemplo.elementoARemover);
        System.out.println(exemplo.hash);
    }
    ...
    public void criaHash() {
        ...
        hash.add(elementoARemover);
    }
    
    public void removeElemento(Sinfonia e) { hash.remove(e); }
}